  ...
  return (
    <>
      <nav
        id="sidebarMenu"
        className={`${
          inOffcanvas ? "col-12 d-md-none" : "col-md-4 col-lg-3 d-md-block py-4 collapse"
        } bg-light sidebar `}
      >
        <div className="position-sticky pt-3">
          <div className="d-flex justify-content-between align-items-center px-3 mb-3">
            <h6 className="sidebar-heading text-black fw-bold mt-2">Categories</h6>
            <button
          ...
          <ul className="nav flex-column">
            <li className="nav-item">
              <a
                className={`nav-link text-black ${currentView === "all" ? "active" : ""}`}
                href="#"
                onClick={(e) => {
                  e.preventDefault();
                  changeView("all");
