...
const TasksContainer = () => {
      ...
      switch (currentView) {
        ...
        case "category":
          filtered = filtered.filter(
            (task) => task.category === currentCategory?._id
          );
          break;
        default:
  ...
  return (
    <div className="tasks-container">
      ...
      {displayFormat === "list" && (
        <TaskList tasks={filteredTasks} loading={isLoadingTasks} />
      )}

      {displayFormat === "calendar" && (
        <TaskCalendarView tasks={filteredTasks} loading={isLoadingTasks} />
      )}

      {displayFormat === "kanban" && (
        <TaskKanbanView tasks={filteredTasks} loading={isLoadingTasks} />
      )}
